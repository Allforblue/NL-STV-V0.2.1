...
8. 分析颗粒度太低，后续考虑使用2016年之前带有经纬度的数据
...
5. 维度统计的小图结果不是很稳定
6. 版本管理还是有问题，有点麻烦
7. 洞察结果有点不太好，需要进一步微调，尤其是进行地图交互之后
8. 行政区与小的区域对应不是太好，行政区交互没有结果
9. 热力图调一下透明度，不要把底图的街道完全覆盖住
10. **代码中有一堆无用代码**
11. 工作流中新对话没有对应逻辑

### bug记录
1. 地图交互有问题，执行完了地图没结果，其他都有，可能是序列化问题
2. 地图交互是走的直接往代码里注入筛选，可能有问题
...
5. 面板优化
6. 交互锚点、图表关系识别
7. 点选和框选交互，使用AST（抽象语法树）注入，绕过LLM提升效率
