...
class InsightExtractor:
    ...
    def generate_insights(
        ...
        # 1. 准备数据背景上下文
        # 提取语义标签，让 AI 知道数字代表的是“价格”还是“经纬度”
        semantic_context = ""
        for s in summaries:
        ...
        2. 业务导向：不要只说“均值是10”，要说“该区域的平均通行成本较高，约为10元”。
        3. 发现异常：特别关注统计数据中的极值或明显的偏差。
        4. 简明扼要：结论要直接，帮助用户快速理解可视化结果背后的业务问题。
        """
        ...
        1. summary: 一句话核心结论。
        2. detail: 包含 2-3 个核心特征点的深度解释。
        3. tags: 提取 3 个关键词标签（如: '高峰拥堵', '显著增长', '空间聚集'）。
